...
const routes: Routes = [
  { path:'auth', loadChildren: () => import('./views/pages/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      ...
      {
        path: 'categories',
        loadChildren: () => import('./views/pages/categorie/categorie.module').then(m => m.CategorieModule)
      },
      {
        path: 'procedures',
        loadChildren: () => import('./views/pages/procedure/procedure.module').then(m => m.ProcedureModule)
      },
      {
        path: 'apps',
